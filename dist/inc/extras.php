	...
	function understrap_post_nav() {
		switch ( get_post_type() ) {
			...
			case 'componente':
				...
				break;
			case 'producto':
				$tax = 'categoria_producto';
				break;
			case 'acabado':
				$tax = 'categoria_acabado';
				break;
		...
		$previous = ( is_attachment() ) ? get_post( get_post()->post_parent ) : get_adjacent_post( true, '', true, $tax );
			...
			<div class="row nav-links justify-content-between">
				<div class="col-md-6">
					...
					if ( get_next_post_link() ) {
						next_post_link( '<span class="nav-previous">%link</span>', _x( '<i class="fa fa-angle-left"></i>&nbsp;%title', 'Previous post link', 'understrap' ), true, '', $tax );
					}
					?>
				</div>
				<div class="col-md-6">
					...
					if ( get_previous_post_link() ) {
						previous_post_link( '<span class="nav-next">%link</span>', _x( '%title&nbsp;<i class="fa fa-angle-right"></i>', 'Next post link', 'understrap' ), true, '', $tax );
					}
					?>
				</div>
			</div><!-- .nav-links -->
